    ...
    <div className="h-screen flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex min-h-0 relative z-10 pb-14 lg:pb-0">
        ...
        {hasInspector && inspector && (
          <aside className="hidden md:flex flex-col w-[min(100%,32rem)] shrink-0 border-l border-neural-cyan/10 overflow-hidden">
            {inspector}
          </aside>
        )}
        ...
        {hasInspector && inspector && (
          <Sheet open={rightOpen} onOpenChange={setRightOpen}>
            ...
            <SheetContent side="right" className="w-[min(100%,32rem)] max-w-[92vw] glass-panel border-neural-cyan/20 p-0">
              {inspector}
            </SheetContent>
          </Sheet>
        )}
